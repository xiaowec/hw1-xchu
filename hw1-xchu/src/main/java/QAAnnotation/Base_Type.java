...
/* First created by JCasGen Tue Sep 10 19:54:00 EDT 2013 */
...
public class Base_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("QAAnnotation.Base");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "QAAnnotation.Base");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "QAAnnotation.Base");
