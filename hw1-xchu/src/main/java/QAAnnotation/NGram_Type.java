...
public class NGram_Type extends Base_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("QAAnnotation.NGram");
  ...
  public int getElements(int addr) {
      ...
      jcas.throwFeatMissing("elements", "QAAnnotation.NGram");
  ...
  public String getElementType(int addr) {
      ...
      jcas.throwFeatMissing("elementType", "QAAnnotation.NGram");
